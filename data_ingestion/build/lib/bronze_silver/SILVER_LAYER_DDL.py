...
- Creates 19 Delta tables in the target `foia_tst.silver`.
- Uses typed Silver table definitions with `CREATE OR REPLACE TABLE`.
- Applies Delta table settings for column mapping and writer/reader compatibility.
"""
...
def run_silver_ddl(spark):
    """Execute all Silver layer DDL statements. Requires active SparkSession."""
...
if __name__ == '__main__':
    run_silver_ddl(spark)  # noqa: F821 (spark provided by Databricks runtime)
